...
export function MainNav() {
  return (
    <div className="hidden items-center gap-8 md:flex font-mono">
      {navItems.map((item) => (
        <Link 
          key={item.name}
      ...
      <Button
        ...
        asChild
      >
        <a href="https://discordapp.com/users/129471053717176320" target="_blank" rel="noopener noreferrer">
        <svg
            role="img"
            viewBox="0 0 24 24"
          ...
          discord 
          <DiscordStatus userId="129471053717176320" />
